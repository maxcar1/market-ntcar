...
import com.maxcar.collector.RankCollector;
import com.maxcar.constants.ResponseConst;
import com.maxcar.pojo.HotSinger;
import com.maxcar.pojo.Rank;
        ...
        StringBuilder stringBuilder = new StringBuilder();
            ...
            switch (wxMessage.getEventKey()) {
                /*case MenuKey.HOT_SONG:
                	stringBuilder.append("http://baidu.com");
                ...
                case MenuKey.XINAO_SONG:
                    ...
                    break;
            	case MenuKey.OWN_MSG:
                collectSongRank(stringBuilder, UrlConst.OWN_MSG_URL);
                break;*/
                default:
